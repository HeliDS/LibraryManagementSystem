...
public class Author {
    ...
    //to insert a new author function
    ...
    //to remove author  
      public void removeAuthor(int _id, String _fname, String _lname, String _expertise, String _about)
    {
        ...
        try {
            ...
            if(ps.executeUpdate() != 0)
            {
                JOptionPane.showMessageDialog(null, "Author Deleted", "remove author", 1);
            }
            else
            {
    ...
    public void editAuthor(String fname, String lname, String expertise, String about) {
...
//to create a function to get author by id
